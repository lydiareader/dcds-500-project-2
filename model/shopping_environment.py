...
class ShoppingEnvironment():
    def __init__(self, mean_desire, std_desire, desire_threshold, average_mean_money, average_std_money, rich_mean_money, average_prob_loyal, rich_prob_loyal, reseller_prob_loyal):
